...
class TestApplyQueryModifiersV2:
    ...
    def test_apply_query_modifiers_v2_order(self, select_query, mock_query_params):
        ...
        with patch('fastapi_restly.query._v2.apply_filtering_v2') as mock_filter:
            with patch('fastapi_restly.query._v2.apply_sorting_v2') as mock_sort:
                with patch('fastapi_restly.query._v2.apply_pagination_v2') as mock_paginate:
