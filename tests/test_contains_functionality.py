...
class TestContainsV1Functionality:
    ...
    def test_contains_v1_string_field_detection(self):
        ...
        from fastapi_ding.query_modifiers import _is_string_field, create_query_param_schema
...
class TestContainsV2Functionality:
    ...
    def test_contains_v2_string_field_detection(self):
        ...
        from fastapi_ding.query_modifiers_v2 import _is_string_field_v2, create_query_param_schema_v2
...
class TestContainsIntegration:
    ...
    def test_contains_v1_complex_scenarios(self):
        ...
        query_params = QueryParams("contains[name]=john jane&contains[email]=example&contains[description]=developer")
    ...
    def test_contains_v2_complex_scenarios(self):
        ...
        # Test multiple contains with multiple values
        query_params = QueryParams("name__contains=john jane&email__contains=example&description__contains=developer")
...
class TestContainsErrorHandling:
    ...
    def test_contains_whitespace_splitting(self):
        ...
        result_v2_comma = apply_filtering_v2(query_params_v2_comma, query, User, UserSchema)
