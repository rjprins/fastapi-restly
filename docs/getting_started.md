...
[Project structure](howto_project_structure.md) covers the full layout, the
...
- [Current context](howto_current.md): bind the current
  user for application code and column defaults.
