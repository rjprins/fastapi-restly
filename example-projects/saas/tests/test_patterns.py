...
class TestPasswordHashing:
    ...
    async def test_stored_value_is_a_real_hash(self, async_client):
    ...
    async def test_change_password_swaps_hash(self, async_client):
...
class TestOutbox:
    async def test_project_create_emits_outbox(self, async_client):
    ...
    async def test_status_transition_emits_event(self, async_client):
        from app.outbox import OutboxEvent
    ...
    async def test_no_event_for_idempotent_update(self, async_client):
...
class TestMultipartUpload:
    ...
    async def test_upload_emits_completion_event(self, async_client):
        from app.outbox import OutboxEvent
