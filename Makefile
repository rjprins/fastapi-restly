...
test-framework:
	@echo "=== Testing FastAPI-Alchemy Framework ==="
...
test-coverage:
	...
	uv run pytest tests/ --cov=fastapi_alchemy --cov-report=term-missing
...
help:
	...
	@echo "  test-framework  - Test the main FastAPI-Alchemy framework"
